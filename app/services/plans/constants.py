...
INACTIVE_SUBSCRIPTION_STATUSES = frozenset({"past_due", "suspended", "cancelled"})
VALID_SUBSCRIPTION_STATUSES = ACTIVE_SUBSCRIPTION_STATUSES | INACTIVE_SUBSCRIPTION_STATUSES
